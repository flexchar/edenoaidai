...
export default {
    data() {
        return {
            ...
            current: 0,
            errorId: '',
            recordings: [1, 2, 3, 4, 7, 11, 13, 17, 21, 24, 31, 37, 38, 43, 47, 49, 50, 53, 62, 65, 72, 78, 86, 90, 92, 94, 95, 100, 102, 103, 104, 106, 109, 113, 114, 121, 122, 125, 130, 144, 150, 153, 161, 163, 164, 165, 167, 168, 173, 176, 177, 179, 186, 187, 189, 195, 201, 204, 218, 219, 237, 246, 249],
        };
    },
    computed: {
        progress() {
